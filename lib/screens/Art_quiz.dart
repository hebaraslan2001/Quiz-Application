...
class ArtQuiz extends StatefulWidget {
  const ArtQuiz({Key? key}) : super(key: key);
  @override
  State<ArtQuiz> createState() => _ArtQuizState();
}

class _ArtQuizState extends State<ArtQuiz> {
  ...
  void initState() {
    ...
    Future(() {
      return Dio()
          .get<String>("https://opentdb.com/api.php?amount=10&category=25");
    }).then((value) {
